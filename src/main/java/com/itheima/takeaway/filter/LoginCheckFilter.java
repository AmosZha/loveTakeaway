package com.itheima.takeaway.filter;
...
public class LoginCheckFilter implements Filter{
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if("employee".equals(session.getAttribute("userType")) && session.getAttribute("employee") != null ){
        ...
        if("user".equals(session.getAttribute("userType")) &&session.getAttribute("user") != null){
